...
Para entenderlo mejor, piensa en una API como un **camarero en un restaurante**:

1. Tú (el usuario o la aplicación cliente) estás sentado en la mesa y miras el menú.
2. Quieres pedir comida (datos o un servicio).
3. No puedes ir directamente a la cocina (el servidor o base de datos) a preparar tu plato.
4. Llamas al **camarero (la API)**, le dices lo que quieres, él toma tu pedido y lo lleva a la cocina.
5. Una vez que la cocina prepara el plato, el camarero te lo trae de vuelta a la mesa.
